...
namespace Panda.Examples.Shooter
{
    public class Unit: MonoBehaviour
    {
        ...
        Vector3 GetMousePosition()
        {
            ...
            mousePosition.z = -Camera.main.worldToCameraMatrix.MultiplyPoint(transform.position).z;
        ...
        {
            return (health / startHealth)*100.0 < percent;
        }
        ...
        public bool SetDestination_WASD()
        {
            ...
            {
                var pos =transform.position + dir.normalized;
                SetDestination(pos);
                isSet = true;
            }
        ...
        public void AimAt_Target()
        {
            ...
            if( Task.isInspected )
                Task.current.debugInfo = string.Format("angle={0}", Vector3.Angle(targetDir, transform.forward));
